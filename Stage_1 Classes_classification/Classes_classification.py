...
@Version: 1.0
@Author: Taoye Yin
@Date: 2019-08-10 14:23:09
@LastEditors: Taoye Yin
@LastEditTime: 2019-08-21 18:02:07
'''
import os#调用系统命令
import sys
...
import copy
os.chdir(sys.path[0])#在vscode中很重要chdir改变路径到当前文件，在vscode中路径是指工作路径
ROOT_DIR = 'E:/Desktop/project/animal_classify/Dataset/'
TRAIN_DIR = 'train/'
VAL_DIR = 'val/'
TRAIN_ANNO = 'E:/Desktop/project/animal_classify/Stage_1 Classes_classification/'+ 'Classes_train_annotation.csv'
VAL_ANNO = 'E:/Desktop/project/animal_classify/Stage_1 Classes_classification/'+'Classes_val_annotation.csv'
